...
def ui_mockup():
    rows = [
        ...
        [p("Domaine", "SmallDiva"), p("GEN - Général", "SmallDiva")],
...
def build():
    ...
    story = [
        ...
        Spacer(1, 10 * mm),
        p("Version publique générique", "SmallDiva"),
        PageBreak(),
        ...
        p("Le nom suit la forme : TYPE-DOMAINE-MOT-CLÉ-VERSION. Le mot-clé peut être long et lisible, par exemple : OUT-GEN-Codification des documents-1.", "BodyDiva"),
        Table([
            [p("Bureau", "WhiteDiva"), p("Domaine", "WhiteDiva"), p("Type", "WhiteDiva"), p("Dossier du document", "WhiteDiva")],
            [p("Dossier racine", "SmallDiva"), p("GEN", "SmallDiva"), p("OUTILS", "SmallDiva"), p("OUT-GEN-Codification des documents-1", "SmallDiva")],
        ...
        p("L'installateur crée un raccourci sur le vrai Bureau Windows, même si le Bureau est redirigé ou porte un autre nom. L'application ne demande pas de compte et ne collecte aucune télémétrie.", "BodyDiva"),
        p("Les modèles et le schéma de classement peuvent rester dans un paquet privé séparé. Ils sont lus depuis %LOCALAPPDATA%\\DivaCartoucheAssistant et ne sont jamais inclus dans le dépôt public.", "BodyDiva"),
        p("Mise à jour", "H"),
