...
def build():
    ...
    story = [
        ...
        Spacer(1, 18 * mm),
        p("Une seule fenêtre : choisissez un modèle, complétez les informations, puis laissez Diva créer le fichier Word et les dossiers parents. Le PDF sera exporté quand le contenu sera terminé.", "BodyDiva"),
        Spacer(1, 10 * mm),
        ...
        p("Quand le contenu est terminé, cliquez sur Document fini. Diva exporte alors le PDF à côté du DOCX. Elle demande ensuite si le document doit entrer dans la gestion documentaire et propose les lieux existants du classeur Excel, avec plusieurs choix possibles.", "BodyDiva"),
        PageBreak(),
